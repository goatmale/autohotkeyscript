;#Include C:\Users\bpl\Desktop\Reference\Scripts\FindClick.ahk
; # win ! alt ^ ctrl + Shift 
; # win ! alt ^ ctrl + Shift 
; & combine keys
; http://www.autohotkey.com/docs/Hotkeys.htm
; --------------
;http://www.autohotkey.com/board/topic/94650-ifwinactive/
SetTitleMatchMode, 2
...
Return
::sudo::
send $(Start-Process powershell -Verb runAs);$(exit)
return
; --------------
::specificially::
send specifically
...
Return
; --------------
;Shift and back mouse button closest to me does screenshot.
^XButton1::
send {PrintScreen}
Return
; --------------
...
Return
; --------------
#IfWinActive, Excel ; Any window with Excel somewhere in the window title. WARNING CASE SENSITIVE
XButton1::
send {F4}
return
#IfWinActive ; Make sure you close the specific section, otherwise ALL further hotkeys are for Excel only.
; --------------
!^z::
;fs - click, 1669,998
;windowed-
...
; --------------
; +$`::Backspace WTF?
;ALWAYS ON TOP TOGGLE: WIN+T
#t::
WinSet, AlwaysOnTop, Toggle,A
return  
; --------------
;PASTE IN COMMAND PROMT: CTRL-V - 2nd winactive is needed to turn off.
...
; --------------
; --------------
; This is the script for autoentering ticket information! Triggered on CTRL + SHIFT + V
~^+v::
sleep 500
send {tab}
send ^a
...
; --------------
; --------------
; http://www.autohotkey.com/board/topic/51959-using-capslock-as-another-modifier-key/
